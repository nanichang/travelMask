                            ...
                            <div class="card card-hidden">
                                ...
                                <div class="content">
                                    <div class="form-group">
                                        ...
                                        <input type="email" placeholder="Enter email" value="{{ old('email') }}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="password" placeholder="Password" value="{{ old('password') }}" class="form-control">
                                    </div>                                    
                                    <div class="form-group">
